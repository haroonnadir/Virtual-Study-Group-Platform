...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['post_discussion'])) {
    ...
    header("Location: admin_enter_group.php?id=$group_id");
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['post_reply'])) {
    ...
    header("Location: admin_enter_group.php?id=$group_id#discussion-$discussion_id");
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['send_message'])) {
    ...
    header("Location: admin_enter_group.php?id=$group_id#messages");
    exit();
}
                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            ...
                            <a href="admin_group_resources.php?id=<?= $group_id ?>" class="btn btn-success">
                                <i class="bi bi-file-earmark"></i> Group Resources
                            </a>
                            <a href="admin_group_schedule.php?id=<?= $group_id ?>" class="btn btn-info">
                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-3 text-center">
                            <a href="admin_group_schedule.php?id=<?= $group_id ?>" class="btn btn-sm btn-outline-secondary">
                                View Full Schedule
                            </a>
                        </div>
                    </div>
